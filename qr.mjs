...
qr=(w)=>((
	...
	d={
		...
		v:[// [...ec,...ap] ec[lv=0~3]:[short_data_l,short_blk_n(,long_blk_n)], ap:[6,...ap,l-7]
			...
			x={x},
			x.l=21+i*4,// モジュール数/辺
			x.ap=i?[6,...x.x.slice(4),x.l-7]:[],// 位置合わせパターン座標
			...
			x.ec=x.x.slice(0,4).map(y=>(y=y.slice(1).reduce((a,c,i)=>(a.b.push({l:y[0]+i,c}),a.e-=(y[0]+i)*c,a.n+=c,a),{b:[],e:x.dw,n:0}),{b:y.b,l:y.e/y.n})),// エラー訂正 cf.p36表9
			delete x.x,a[x.v=i+1]=x,a
		),{})
	},
