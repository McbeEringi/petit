...
//progress=(w,f)=>((r=w.body.getReader(),s=[0,+w.headers.get('content-length')])=>Array.fromAsync({[Symbol.asyncIterator]:_=>(f(s),{next:async x=>(x=(await r.read()).value,x&&(s[0]+=x.length,f(s)),{done:!x,value:x})})}))();
